...
4. Добавляем дополнительно заголовки кэширования на все статичные файлы, кроме /index.html, чтобы контент получать правильно.
5. После этого мы отправляем все это конечному пользователю с дополнительной настройкой cf в виде cacheTtl длительностью в 1 год (это нужно, чтобы статика имела статус HIT для тех файлов, которые были кэшированы)
## Caching
#### SSL/TLS
- **TLS 1.3:** Enable
